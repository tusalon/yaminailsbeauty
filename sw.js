...
const urlsToCache = [
  ...
  '/yaminailsbeauty/vendor/react.production.min.js',
  '/yaminailsbeauty/vendor/react-dom.production.min.js',
  '/yaminailsbeauty/vendor/babel.min.js',
  '/yaminailsbeauty/vendor/bcrypt.min.js',
  '/yaminailsbeauty/vendor/tailwind-browser.js',
  '/yaminailsbeauty/vendor/lucide/lucide.css',
  '/yaminailsbeauty/vendor/lucide/lucide.woff2',
  '/yaminailsbeauty/utils/push-config.js',
  '/yaminailsbeauty/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/yaminailsbeauty/icons/icon-192x192.png',
    badge: '/yaminailsbeauty/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/yaminailsbeauty/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/yaminailsbeauty/admin.html';
  event.waitUntil(
